...
class Robot : public frc::TimedRobot
{
  public:
	...
	Timer *TimerA, *TimerX, *TimerY, *TimerM;
...
enum bOperator
{
	...
	bHatchCollect = 13,  //used to be turn on output wheels
	bHatchFloor = 5,	 //
	bHatchLow = 6,		 //set low hatch level
	bHatchMid = 7,		 //set mid hatch level
	bHatchOut = 8,		 //turn on hatch pistons
	bHome = 19,			 //used to be set to home position
	bCargoShip = 20,	 //used to be claw set home
